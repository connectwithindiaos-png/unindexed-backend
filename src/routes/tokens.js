...
router.post('/:id/icon', iconController.upload.bind(iconController));
router.get('/:id/icon', iconController.get.bind(iconController));
router.delete('/:id/icon', iconController.delete.bind(iconController));
